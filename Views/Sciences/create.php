      ...
      <div class="content-wrapper">
          <div class="content-header row">
              <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title">เพิ่มสายวิชาการ</h3>
          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">เพิ่มสายวิชาการ</li>
              </ol>
          </nav>
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              <div class="row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <label class="col-md-6 label-control" for="userinput2">ชื่อย่อสายวิชาการ</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative">
