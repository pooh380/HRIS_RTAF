    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <h3 class="content-header-title">ประเภทการสูญเสีย</h3>
        </div>
      </div>
                  ...
                  <div class="card-body card-dashboard">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../home/index.php">ข้อมูล</a></li>
                        <li class="breadcrumb-item active" aria-current="page">ประเภทการสูญเสีย</li>
                      </ol>
                    </nav>
