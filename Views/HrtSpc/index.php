              ...
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <table id="getHrtSpc" class="table table-striped table-borderless table-hover bootstrap-3 " style="width:100%;">
                      <thead>
  ...
  <script src="../../Controllers/HrtSpcController.js"></script>
