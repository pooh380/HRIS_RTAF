...
<head>
    ...
    <title>Crypto Dashboard - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard
    </title>
...
>>>>>>> 0e15990252323b883de809b811b30fea9a434991
    ...
    <div class="main-menu  menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main bgLeftcolor" style="background-color: #1A1D52; color: #FAFAFA!important;" data-menu="menu-navigation">
                    ...
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#" data-i18n="nav.page_layouts.3_columns.main">ข้อมูลทั่วไป</a>
                            <ul class="menu-content">
                                ...
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">เชื้อชาติ</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ศาสนา</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">จังหวัด</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">เขต/อำเภอ</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">รหัสไปรษณีย์</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">อัตรา</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ลำดับการจัดเรียงยศ</a>
                                </li>
                        ...
                        <li><a class="menu-item" href="#" data-i18n="nav.page_layouts.3_columns.main">โครงสร้าง</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ประเภทโครงสร้าง</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">โครงสร้าง</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ส่วนราชกาล</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ฐานะหน่วย</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">สังกัด</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">หน่วยงาน</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">หัวหน้าสายวิทยาการ</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">สายวิทยาการ</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">โครงสร้างอัตราส่วน ราชการ</a>
                                </li>
                                <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">สังกัด-สายวิทยาการ</a>
                            </ul>
                        </li>
                </li>
                <li><a class="menu-item" href="#" data-i18n="nav.page_layouts.3_columns.main">ตำแแหน่ง</a>
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ชื่อตำแหน่ง</a>
                        </li>
                        <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">อัตราตำแหน่งในโครงสร้างอัตรา</a>
                        </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">ระบบงานทำเนียบกำลังพล</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">ระบบงานวิเคราะห์ความต้องการกำลังพลประจำปี</span></a>
                <ul class="menu-content">
            ...
            <!-- ระบบงานโอนย้าย -->
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">ระบบงานโอนย้าย</span></a>
                <ul class="menu-content">
            ...
            <!-- งานประวัติรับราชการ -->
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">งานประวัติรับราชการ</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="navbar-light.html" data-i18n="nav.navbars.nav_light">ประวัติรับราชการ</a>
                    </li>
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="layout-content-left-sidebar.html" data-i18n="nav.page_layouts.3_columns.left_sidebar">ข้อมูลตำแหน่ง</a>
                        </li>
            ...
            <!-- งานตรวจสอบประวัติรับราชการ -->
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">งานตรวจสอบประวัติรับราชการ</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="navbar-light.html" data-i18n="nav.navbars.nav_light">ตรวจสอบประวัติรับราชการ</a>
                    </li>
                    <li><a class="menu-item" href="navbar-light.html" data-i18n="nav.navbars.nav_light">คำขอแก้ไขประวัติ</a>
                    </li>
                    <li><a class="menu-item" href="navbar-light.html" data-i18n="nav.navbars.nav_light">กำหนดการตรวจสอบข้อมูล</a>
                    </li>
                </ul>
            </li>
            <!-- งานส่วนกลางสำหรับผู้ดูแลระบบ -->
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">งานส่วนกลางสำหรับผู้ดูแลระบบ</span></a>
                <ul class="menu-content">
